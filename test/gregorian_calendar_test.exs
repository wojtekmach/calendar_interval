defmodule GregorianCalendarIntervalTest do
  ...
  test "parse!/1" do
    ...
    assert i.first ==
             ~N"2018-06-15 00:00:00.000000" |> Map.put(:calendar, Cldr.Calendar.Gregorian)
    ...
    assert i.first ==
             ~N"2018-06-15 10:20:30.123000" |> Map.put(:calendar, Cldr.Calendar.Gregorian)
    ...
    assert i.first ==
             ~N"2018-06-15 10:20:30.123456" |> Map.put(:calendar, Cldr.Calendar.Gregorian)
  ...
  test "next/1" do
    ...
    assert i.first ==
             ~N"2018-02-01 00:00:00.000000" |> Map.put(:calendar, Cldr.Calendar.Gregorian)
    ...
    assert i.first ==
             ~N"2018-03-01 00:00:00.000000" |> Map.put(:calendar, Cldr.Calendar.Gregorian)
    ...
    assert i.first ==
             ~N"2018-05-01 00:00:00.000000" |> Map.put(:calendar, Cldr.Calendar.Gregorian)
  ...
  test "prev/1" do
    ...
    assert i.first ==
             ~N"2017-12-01 00:00:00.000000" |> Map.put(:calendar, Cldr.Calendar.Gregorian)
  ...
  test "enclosing/1" do
    ...
    assert i.first ==
             ~N"2018-02-03 10:20:30.123000" |> Map.put(:calendar, Cldr.Calendar.Gregorian)
    ...
    assert i.first ==
             ~N"2018-02-03 10:20:30.000000" |> Map.put(:calendar, Cldr.Calendar.Gregorian)
    ...
    assert i.first ==
             ~N"2018-02-03 10:20:00.000000" |> Map.put(:calendar, Cldr.Calendar.Gregorian)
    ...
    assert i.first ==
             ~N"2018-02-03 10:00:00.000000" |> Map.put(:calendar, Cldr.Calendar.Gregorian)
    ...
    assert i.first ==
             ~N"2018-02-03 00:00:00.000000" |> Map.put(:calendar, Cldr.Calendar.Gregorian)
